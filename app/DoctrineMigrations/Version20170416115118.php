...
class Version20170416115118 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE book_rating (book_rating_id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, user_id INT DEFAULT NULL, rating DOUBLE PRECISION DEFAULT NULL, INDEX IDX_F15E2DAF16A2B381 (book_id), INDEX IDX_F15E2DAFA76ED395 (user_id), PRIMARY KEY(book_rating_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE book_review (book_review_id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, user_id INT DEFAULT NULL, text LONGTEXT NOT NULL, approved TINYINT(1) NOT NULL, created_on DATETIME NOT NULL, updated_on DATETIME DEFAULT NULL, INDEX IDX_50948A4B16A2B381 (book_id), INDEX IDX_50948A4BA76ED395 (user_id), PRIMARY KEY(book_review_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
