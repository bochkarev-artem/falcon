...
class Version20170106191954 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE author (author_id INT AUTO_INCREMENT NOT NULL, litres_hub_id INT DEFAULT NULL, document_id VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, middle_name VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, level INT DEFAULT NULL, review_count INT DEFAULT NULL, arts_count INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, photo_url VARCHAR(255) DEFAULT NULL, photo_name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX author_ids (document_id), PRIMARY KEY(author_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE book (book_id INT AUTO_INCREMENT NOT NULL, sequence_id INT DEFAULT NULL, litres_hub_id INT NOT NULL, price VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, cover_preview VARCHAR(255) DEFAULT NULL, cover_preview_url VARCHAR(255) DEFAULT NULL, cover_preview_name VARCHAR(255) DEFAULT NULL, cover_name VARCHAR(255) DEFAULT NULL, cover_url VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL, book_type INT DEFAULT NULL, has_trial TINYINT(1) DEFAULT NULL, reader VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, annotation LONGTEXT DEFAULT NULL, date VARCHAR(255) DEFAULT NULL, lang VARCHAR(255) DEFAULT NULL, sequence_number INT DEFAULT NULL, document_id VARCHAR(255) DEFAULT NULL, publisher VARCHAR(255) DEFAULT NULL, city_published VARCHAR(255) DEFAULT NULL, year_published VARCHAR(4) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, rating DOUBLE PRECISION DEFAULT NULL, review_count INT DEFAULT NULL, INDEX IDX_CBE5A33198FB19AE (sequence_id), UNIQUE INDEX book_ids (litres_hub_id), PRIMARY KEY(book_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
