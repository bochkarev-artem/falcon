...
class Version20160429154935 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE genre (genre_id INT NOT NULL, litres_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, type INT DEFAULT NULL, PRIMARY KEY(genre_id))');
        $this->addSql('CREATE UNIQUE INDEX genre_ids ON genre (litres_id, title)');
